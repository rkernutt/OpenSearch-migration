...
describe('EuiVisColorStore', function () {
  ...
  describe('setVisColors()', function () {
    var customColors = _objectSpread(_objectSpread({}, visColors), {}, {
      euiColorVis0: '#00ff00'
    });
    it('has initial colors', function () {
      expect(visColorStore.visColors).toEqual(visColors);
    });
    it('updates colors', function () {
  ...
  describe('subcribe and unsubscribe', function () {
    it('subscribes to store updates', function () {
      ...
      var id = visColorStore.subscribe(_vis_color_store.VIS_COLOR_STORE_EVENTS.UPDATE, updateFn);
    ...
    it('unsubscribes from store updates', function () {
      var customColors = _objectSpread(_objectSpread({}, visColors), {}, {
        euiColorVis0: '#0000ff'
      });
      var id = visColorStore.subscribe(_vis_color_store.VIS_COLOR_STORE_EVENTS.UPDATE, updateFn);
      expect(id).toContain('UPDATE');
      visColorStore.unsubscribe(_vis_color_store.VIS_COLOR_STORE_EVENTS.UPDATE, id);
      visColorStore.setVisColors(customColors);
      jest.runAllTimers();
