 ...
 */
var EuiWrappingPopover = exports.EuiWrappingPopover = /*#__PURE__*/function (_Component) {
  function EuiWrappingPopover() {
    ...
    (0, _defineProperty2.default)(_this, "portal", null);
    (0, _defineProperty2.default)(_this, "setPortalRef", function (node) {
      _this.portal = node;
    });
    (0, _defineProperty2.default)(_this, "setAnchorRef", function (node) {
  ...
  return (0, _createClass2.default)(EuiWrappingPopover, [{
