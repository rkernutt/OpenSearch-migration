...
var _EuiSplitPanelInner = exports._EuiSplitPanelInner = function _EuiSplitPanelInner(_ref) {
  ...
  var borderDirection = (0, _react.useContext)(SplitPanelInnerBorderDirection);
  ...
  var cssStyles = [styles.euiSplitPanelInner, borderDirection && styles.highContrastBorders[borderDirection]];
  var panelProps = {
    hasShadow: false,
    color: 'transparent',
    borderRadius: 'none',
...
var _EuiSplitPanelOuter = exports._EuiSplitPanelOuter = function _EuiSplitPanelOuter(_ref2) {
  ...
  var responsiveDirection = direction === 'row' && !isResponsive ? 'row' : 'column';
  var innerBorderDirection = (0, _panel._canRenderHighContrastBorder)(_objectSpread({}, rest)) ? responsiveDirection : undefined;
  var styles = _split_panel.euiSplitPanelOuterStyles;
  var cssStyles = [styles.euiSplitPanelOuter, styles[responsiveDirection]];
  ...
  return (0, _react2.jsx)(_panel.EuiPanel, (0, _extends2.default)({
    ...
    className: classes,
    css: cssStyles
  }, rest), (0, _react2.jsx)(SplitPanelInnerBorderDirection.Provider, {
    value: innerBorderDirection
  }, children));
};
var SplitPanelInnerBorderDirection = /*#__PURE__*/(0, _react.createContext)(undefined);
