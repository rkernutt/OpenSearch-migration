...
var EuiColorPaletteDisplayFixed = exports.EuiColorPaletteDisplayFixed = function EuiColorPaletteDisplayFixed(_ref) {
  var palette = _ref.palette,
    title = _ref.title,
    rest = (0, _objectWithoutProperties2.default)(_ref, _excluded);
  var paletteStops = (0, _react.useMemo)(function () {
    var fixedGradient = (0, _utils.getFixedLinearGradient)(palette);
    return fixedGradient.map(function (item, index) {
