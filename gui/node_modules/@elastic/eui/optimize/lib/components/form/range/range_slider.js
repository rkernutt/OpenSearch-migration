...
var EuiRangeSlider = exports.EuiRangeSlider = function EuiRangeSlider(_ref) {
  ...
  var cssStyles = [styles.euiRangeSlider, showTicks && styles.hasTicks, showRange && styles.hasRange];
  var sliderStyle = (0, _react.useMemo)(function () {
    return (0, _global_styling.logicalStyles)(_objectSpread({
      // @ts-ignore - CSS variable
      '--euiRangeThumbColor': thumbColor && (0, _range_levels_colors.euiRangeLevelColor)(thumbColor, euiTheme)
    }, style));
