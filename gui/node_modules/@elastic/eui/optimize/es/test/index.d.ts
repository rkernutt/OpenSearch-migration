declare module '@elastic/eui/optimize/es/test/required_props' {
...
declare module '@elastic/eui/optimize/es/test/take_mounted_snapshot' {
...
declare module '@elastic/eui/optimize/es/test/react_warnings' {
...
declare module '@elastic/eui/optimize/es/test' {
	...
	export { takeMountedSnapshot } from '@elastic/eui/optimize/es/test/take_mounted_snapshot';
