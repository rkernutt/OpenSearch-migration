...
var EuiIconBulb = function EuiIconBulb(_ref) {
  ...
  return ___EmotionJSX("svg", _extends({
    ...
    d: "m3.923 8.929-1.733 1-.5-.867 1.733-1 .5.867Zm10.397.134-.5.866-1.732-1 .5-.867 1.731 1ZM3.005 6.495h-2v-1h2v1Zm12 0h-2v-1h2v1ZM3.928 3.063l-.501.866-1.732-1 .5-.866 1.733 1Zm10.387-.134-1.732 1-.5-.866 1.732-1 .5.866Z"
  }));
};
export var icon = EuiIconBulb;