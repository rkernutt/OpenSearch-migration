...
export var euiCodeBlockStyles = function euiCodeBlockStyles(euiThemeContext) {
  var codeSyntaxVariables = euiCodeSyntaxVariables(euiThemeContext);
  var euiTheme = euiThemeContext.euiTheme;
  return {
    euiCodeBlock: /*#__PURE__*/css("max-inline-size:100%;display:block;position:relative;background:", codeSyntaxVariables.backgroundColor, ";", highContrastModeStyles(euiThemeContext, {
    ...
    }), " ", codeSyntaxVariables.tokensCss, ";;label:euiCodeBlock;"),
    // Font size
...
export var euiCodeBlockCodeStyles = function euiCodeBlockCodeStyles(euiThemeContext) {
  var euiTheme = euiThemeContext.euiTheme;
  return {
    euiCodeBlock__code: /*#__PURE__*/css("font-family:", euiTheme.font.familyCode, ";font-size:inherit;color:", euiTheme.colors.textParagraph, ";display:block;;label:euiCodeBlock__code;"),
    isVirtualized: _ref
  };
};
