...
export var isNamedLevelColor = function isNamedLevelColor(color) {
  return LEVEL_COLORS.includes(color);
};
export var euiRangeLevelColor = function euiRangeLevelColor(color, _ref) {
  var euiTheme = _ref.euiTheme;
  return isNamedLevelColor(color) ? euiTheme.colors[color] : color;
};
export var getLevelColor = function getLevelColor(levels, value) {
  var color;
