...
exports.printIso8601 = exports.dateGranularity = exports.dateFormat = exports.Granularity = void 0;
...
var Granularity = exports.Granularity = Object.freeze({
  DAY: {
    es: 'd',
    js: 'day',
...
var printIso8601 = exports.printIso8601 = function printIso8601(value) {
  return utc(value).format(_moment.default.defaultFormatUtc);
};
var dateGranularity = exports.dateGranularity = function dateGranularity(parsedDate) {
  return parsedDate[GRANULARITY_KEY];
};
var dateFormat = exports.dateFormat = Object.freeze({
