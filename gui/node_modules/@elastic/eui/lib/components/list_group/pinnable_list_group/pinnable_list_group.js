...
var EuiPinnableListGroup = exports.EuiPinnableListGroup = function EuiPinnableListGroup(_ref) {
  ...
  var styles = (0, _services.useEuiMemoizedStyles)(_pinnable_list_group.euiPinnableListGroupItemExtraActionStyles);
  var pinExtraActionLabel = (0, _i18n.useEuiI18n)('euiPinnableListGroup.pinExtraActionLabel', 'Pin item');
  var pinnedExtraActionLabel = (0, _i18n.useEuiI18n)('euiPinnableListGroup.pinnedExtraActionLabel', 'Unpin item');

  // Alter listItems object with extra props
  var pinnableListItems = (0, _react.useMemo)(function () {
    return listItems.map(function (item) {
      ...
      if (pinnable && !itemProps.extraAction) {
        ...
        if (pinned) {
          var title = unpinTitle ? unpinTitle(item) : pinnedExtraActionLabel;
          itemProps.extraAction = _objectSpread(_objectSpread({}, sharedProps), {}, {
            alwaysShow: true,
            'aria-label': title,
            title: title
          });
        } else {
          var _title = pinTitle ? pinTitle(item) : pinExtraActionLabel;
          itemProps.extraAction = _objectSpread(_objectSpread({}, sharedProps), {}, {
            'aria-label': _title,
            title: _title
          });
  ...
  }, [listItems, pinTitle, pinExtraActionLabel, unpinTitle, pinnedExtraActionLabel, onPinClick, styles]);
  return (0, _react2.jsx)(_list_group.EuiListGroup, _extends({
    className: classes,
    listItems: pinnableListItems
  }, rest));
};
