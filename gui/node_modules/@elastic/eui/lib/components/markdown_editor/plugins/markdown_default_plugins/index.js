...
Object.keys(_ui_plugins).forEach(function (key) {
  ...
  if (key in exports && exports[key] === _ui_plugins[key]) return;
...
Object.keys(_parsing_plugins).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _parsing_plugins[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
Object.keys(_processing_plugins).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _processing_plugins[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
