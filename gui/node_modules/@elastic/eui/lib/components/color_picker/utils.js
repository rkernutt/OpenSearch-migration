...
exports.parseColor = exports.getLinearGradient = exports.getFixedLinearGradient = exports.getEventPosition = exports.getChromaColor = exports.chromaValid = exports.RGB_JOIN = exports.RGB_FALLBACK = exports.HSV_FALLBACK = exports.HEX_FALLBACK = void 0;
 ...
 */
var getEventPosition = exports.getEventPosition = function getEventPosition(location, container) {
  var x = location.x,
    y = location.y;
  ...
  var leftPos = x - (left + window.scrollX);
  var topPos = y - (top + window.scrollY);
  if (leftPos < 0) {
    leftPos = 0;
...
var HEX_FALLBACK = exports.HEX_FALLBACK = '';
var HSV_FALLBACK = exports.HSV_FALLBACK = [0, 0, 0];
var RGB_FALLBACK = exports.RGB_FALLBACK = [NaN, NaN, NaN, 1];
var RGB_JOIN = exports.RGB_JOIN = ', ';

// Given a string, this attempts to return a format that can be consumed by chroma-js
var parseColor = exports.parseColor = function parseColor(input) {
  var parsed;
...
var chromaValid = exports.chromaValid = function chromaValid(color) {
  var parsed = color;
...
var getChromaColor = exports.getChromaColor = function getChromaColor(input) {
...
var getLinearGradient = exports.getLinearGradient = function getLinearGradient(palette) {
...
var getFixedLinearGradient = exports.getFixedLinearGradient = function getFixedLinearGradient(palette) {
  var paletteHasStops = palette.some(function (item) {
    return _typeof(item) === 'object';
  });
  if (paletteHasStops) {
