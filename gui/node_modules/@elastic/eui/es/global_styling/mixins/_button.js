...
export var getEuiButtonColorValues = function getEuiButtonColorValues(euiThemeContext, color) {
...
export var getEuiFilledButtonColorValues = function getEuiFilledButtonColorValues(euiThemeContext, color) {
        ...
        case 'base':
          {
            ...
            displaysColorsMap[display][color] = /*#__PURE__*/css(euiButtonColor(euiThemeContext, color), " ", euiButtonInteractionStyles(euiThemeContext, buttonColors, 'overlay'), " ", borderStyle, ";;label:displaysColorsMap-display-color;");
            break;
          }
        case 'fill':
          {
        ...
        case 'empty':
          {
            ...
            displaysColorsMap[display][color] = /*#__PURE__*/css("color:", euiButtonEmptyColor(euiThemeContext, color).color, ";", euiButtonInteractionStyles(euiThemeContext, _buttonColors2, 'overlay'), ";;label:displaysColorsMap-display-color;");
            break;
          }
      }
 ...
 */
export var euiButtonInteractionStyles = function euiButtonInteractionStyles(euiThemeContext, buttonColors) {
