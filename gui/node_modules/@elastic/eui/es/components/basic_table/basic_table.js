...
export var EuiBasicTable = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(EuiBasicTable, [{
    ...
    value: function renderTableCaption() {
      ...
      if (!itemCount) {
        itemCountPart = ___EmotionJSX(React.Fragment, null, noItemsMessage, !!noItemsMessage && ',');
