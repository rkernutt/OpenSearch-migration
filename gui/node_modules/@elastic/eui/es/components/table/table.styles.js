...
import { euiFontSize, euiNumberFormat, mathWithUnits } from '../../global_styling';
export var euiTableVariables = function euiTableVariables(_ref6) {
...
export var euiTableStyles = function euiTableStyles(euiThemeContext) {
  ...
  return {
    euiTable: /*#__PURE__*/css(euiNumberFormat(euiThemeContext), " inline-size:100%;border:none;border-collapse:collapse;;label:euiTable;"),
