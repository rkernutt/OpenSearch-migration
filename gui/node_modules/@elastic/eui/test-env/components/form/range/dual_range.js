 ...
 */
var EuiDualRangeClass = exports.EuiDualRangeClass = /*#__PURE__*/function (_Component) {
  function EuiDualRangeClass() {
    ...
    (0, _defineProperty2.default)(_this, "leftPosition", 0);
    (0, _defineProperty2.default)(_this, "dragAcc", 0);
    (0, _defineProperty2.default)(_this, "_determineInvalidThumbMovement", function (newVal, lower, upper, e) {
    ...
    (0, _defineProperty2.default)(_this, "_determineValidThumbMovement", function (newVal, lower, upper, e) {
    ...
    (0, _defineProperty2.default)(_this, "_determineThumbMovement", function (newVal, e) {
    ...
    (0, _defineProperty2.default)(_this, "_handleOnChange", function (lower, upper, e) {
    ...
    (0, _defineProperty2.default)(_this, "handleSliderChange", function (e) {
      _this._determineThumbMovement(Number(e.currentTarget.value), e);
    });
    (0, _defineProperty2.default)(_this, "_resetToRangeEnds", function (e) {
    ...
    (0, _defineProperty2.default)(_this, "_isDirectionalKeyPress", function (event) {
    ...
    (0, _defineProperty2.default)(_this, "handleInputKeyDown", function (e) {
    ...
    (0, _defineProperty2.default)(_this, "handleLowerInputChange", function (e) {
      _this._handleOnChange(e.target.value, _this.upperValue, e);
    });
    (0, _defineProperty2.default)(_this, "handleUpperInputChange", function (e) {
      _this._handleOnChange(_this.lowerValue, e.target.value, e);
    });
    (0, _defineProperty2.default)(_this, "_handleKeyDown", function (value, event) {
    ...
    (0, _defineProperty2.default)(_this, "handleLowerKeyDown", function (event) {
    ...
    (0, _defineProperty2.default)(_this, "handleUpperKeyDown", function (event) {
    ...
    (0, _defineProperty2.default)(_this, "handleDraggableKeyDown", function (event) {
      var lower = _this.lowerValue;
      var upper = _this.upperValue;
      switch (event.key) {
        case _services.keys.TAB:
    ...
    (0, _defineProperty2.default)(_this, "calculateThumbPositionStyle", function (value, width) {
    ...
    (0, _defineProperty2.default)(_this, "onThumbFocus", function (e) {
      if (_this.props.onFocus) {
        _this.props.onFocus(e);
      }
    });
    (0, _defineProperty2.default)(_this, "onThumbBlur", function (e) {
    ...
    (0, _defineProperty2.default)(_this, "setRangeWidth", function (_ref) {
      var width = _ref.width;
      _this.setState({
        rangeWidth: width
      });
    });
    (0, _defineProperty2.default)(_this, "getNearestStep", function (value) {
      var min = _this.props.min;
      var max = _this.props.max;
    ...
    (0, _defineProperty2.default)(_this, "handleDrag", function (x, isFirstInteraction) {
  ...
  return (0, _createClass2.default)(EuiDualRangeClass, [{
    key: "isInPopover",
    get: function get() {
    ...
    value: function render() {
      ...
      var leftThumbStyles = leftThumbColor ? _objectSpread(_objectSpread({}, leftThumbPosition), {}, {
        '--euiRangeThumbColor': (0, _range_levels_colors.euiRangeLevelColor)(leftThumbColor, theme)
      }) : leftThumbPosition;
      var rightThumbStyles = rightThumbColor ? _objectSpread(_objectSpread({}, rightThumbPosition), {}, {
        '--euiRangeThumbColor': (0, _range_levels_colors.euiRangeLevelColor)(rightThumbColor, theme)
      }) : rightThumbPosition;
...
var EuiDualRange = exports.EuiDualRange = (0, _services.withEuiTheme)(EuiDualRangeClass);