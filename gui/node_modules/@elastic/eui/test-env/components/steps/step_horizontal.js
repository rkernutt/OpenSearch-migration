...
var EuiStepHorizontal = exports.EuiStepHorizontal = function EuiStepHorizontal(_ref) {
  ...
  var styles = (0, _services.useEuiMemoizedStyles)(_step_horizontal.euiStepHorizontalStyles);
  var cssStyles = [styles.euiStepHorizontal, styles[size], status === 'disabled' ? styles.disabled : styles.enabled];
  var numberStyles = (0, _services.useEuiMemoizedStyles)(_step_horizontal.euiStepHorizontalNumberStyles);
