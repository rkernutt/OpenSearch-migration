...
EuiComboBoxOptionsList.propTypes = {
  ...
  setListOptionRefs: _propTypes.default.func.isRequired,
  ...
  rowHeight: _propTypes.default.oneOfType([_propTypes.default.number.isRequired, _propTypes.default.oneOf(["auto"])]).isRequired,
