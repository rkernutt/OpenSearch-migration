...
var euiTextTruncateStyles = exports.euiTextTruncateStyles = function euiTextTruncateStyles(euiThemeContext) {
  return {
    euiTextTruncate: _ref2,
    /**
    ...
    euiTextTruncate__truncatedText: _ref,
    ...
    euiTextTruncate__fullText: /*#__PURE__*/(0, _react.css)("position:absolute;inset:0;overflow:hidden;color:rgba(0, 0, 0, 0);@supports (-webkit-hyphens: none){text-overflow:ellipsis;}", (0, _high_contrast.preventForcedColors)(euiThemeContext), ";;label:euiTextTruncate__fullText;")
  };
};