...
var useContainerCallbacks = exports.useContainerCallbacks = function useContainerCallbacks(_ref) {
      ...
      case 'EUI_RESIZABLE_DRAG_MOVE':
        {
          ...
          if (prevPanelSize >= prevPanelMin && nextPanelSize >= nextPanelMin) {
            return withSideEffect(_objectSpread(_objectSpread({}, state), {}, {
              ...
              panels: _objectSpread(_objectSpread({}, state.panels), {}, (0, _defineProperty2.default)((0, _defineProperty2.default)({}, _prevPanelId, _objectSpread(_objectSpread({}, state.panels[_prevPanelId]), {}, {
                size: prevPanelSize
      ...
      case 'EUI_RESIZABLE_KEY_MOVE':
        {
          ...
          if (_prevPanelSize >= _prevPanelMin && _nextPanelSize >= _nextPanelMin) {
            return withSideEffect(_objectSpread(_objectSpread({}, state), {}, {
              isDragging: false,
              panels: _objectSpread(_objectSpread({}, state.panels), {}, (0, _defineProperty2.default)((0, _defineProperty2.default)({}, _prevPanelId2, _objectSpread(_objectSpread({}, state.panels[_prevPanelId2]), {}, {
                size: _prevPanelSize
