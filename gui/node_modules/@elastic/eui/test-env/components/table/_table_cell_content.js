...
var EuiTableCellContent = exports.EuiTableCellContent = function EuiTableCellContent(_ref) {
  ...
  var cssStyles = [styles.euiTableCellContent, styles[align], truncateText === true && styles.truncateText, truncateText === false && styles.wrapText].concat((0, _toConsumableArray2.default)(hasActions ? [styles.hasActions.actions, hasActions === 'custom' && styles.hasActions.custom, !isResponsive && styles.hasActions.desktop, isResponsive && hasActions !== 'custom' && styles.hasActions.mobile] : []));
